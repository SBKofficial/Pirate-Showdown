...
def get_stats_text(char_obj_or_name, player_fruit=None):
    # This maintains your exact UI layout
    ...
    # MOVES/ULT logic from original bot.py constants
    # (In a full refactor, MOVES and EFFECT_DESCRIPTIONS should also be in JSON)
